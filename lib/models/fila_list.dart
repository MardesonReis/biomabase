...
class FilaList with ChangeNotifier {
  ...
  Future<String> Agendar(Fila fila) async {
    ...
    Map<String, String> param = {
      ...
      "paciente": fila.indicado.pacientes_id,
      ...
      "telefoneagenda": fila.indicado.pacientes_celular,
      "formapgto": '1',
      "transacao": '',
      "codusuario": "99",
      ...
      "nomepaciente": fila.indicado.pacientes_nomepaciente,
      "especialidade": fila.procedimento.especialidade.codespecialidade,
      "visivel": "S",
      "unidadeagendamento": "1",
      "procedimentos": fila.procedimento.des_procedimentos,
      "codparceiro": fila.indicando.pacientes_id,
      "regime": "N",
      "teleatendimento": "f",
      "confirmadorobo": "f"
    };
  ...
  Future<String> ProcedimentosAgendados(Fila fila) async {
    ...
    Map<String, String> param = {
      ...
      'datamovimento': fila.data,
      'tratamento': fila.procedimento.cod_tratamento,
      'procedimento': fila.procedimento.cod_procedimentos,
      'status': 'A',
      'pacientereserva': fila.indicado.pacientes_nomepaciente,
      ...
      'codprofissional': fila.medico.cod_profissional,
      'unidade': fila.unidade.cod_unidade,
      'especialidades': fila.procedimento.especialidade.codespecialidade,
      'codtabela': fila.convenios.cod_convenio,
      'nratendimento': fila.sequencial,
      'id_codigo': fila.convenios.cod_convenio,
      'id_nragendado': '',
      'encaminhadopor': fila.indicando.pacientes_cpf,
      'origem': '',
      'biometriaautorizada': '',
      'atendente': '99',
      'codparceiro': fila.indicando.pacientes_id,
  ...
  Future<String> GerarFilaIndicacao(Fila fila) async {
    ...
    Map<String, String> param = {
      ...
      "autor": fila.indicando.pacientes_cpf,
      "visivel": "S",
    };
  ...
  Future<String> SalvaIndicacao(Fila fila, String id_indicacao) async {
    ...
    Map<String, String> param = {
      ...
      'cod_procedimento': fila.procedimento.cod_procedimentos,
      'des_procedimento': fila.procedimento.des_procedimentos,
      ...
      'cod_especialidade': fila.procedimento.especialidade.codespecialidade,
      'des_especialidade': fila.procedimento.especialidade.descricao,
      'status': 'A',
