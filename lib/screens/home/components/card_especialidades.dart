...
class EspecialidadesView extends StatefulWidget {
  EspecialidadesView({Key? key, required this.especialidade}) : super(key: key);
            ...
            child: SectionTitle(
              ...
              pressOnSeeAll: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => EspecialidadesScreen(),
                  ),
                );
              },
              OnSeeAll: true,
            ...
            child: Center(
              child: Wrap(
                ...
                children: List.generate(
                  widget.especialidade.length,
                  (index) => Center(
                    child: EspecialidadesCard(
                      esp: widget.especialidade[index],
                      press: () {
                        setState(() {});
                      },
                    ),
