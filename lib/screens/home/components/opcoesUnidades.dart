...
class opcoesUnidades extends StatefulWidget {
  opcoesUnidades({this.title = ''});

  final String title;

  @override
  _opcoesUnidades createState() => _opcoesUnidades();
}

class _opcoesUnidades extends State<opcoesUnidades> {
