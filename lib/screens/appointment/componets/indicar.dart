...
class Indicar extends StatefulWidget {
  Medicos doctor;
  ...
  @override
  _IndicarState createState() => _IndicarState();
}

class _IndicarState extends State<Indicar> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    title: Text('Informar local de atendimento ?'),
                  ),
                  if (_expanded)
                    InforUnidade(
