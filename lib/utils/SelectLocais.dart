...
class SelectLocais extends StatefulWidget {
  VoidCallback press;
  bool multe = false;
  SelectLocais({Key? key, required this.press, this.multe = false})
      : super(key: key);

  @override
  State<SelectLocais> createState() => _SelectLocaisState();
}

class _SelectLocaisState extends State<SelectLocais> {
